  ...
  describe("save_lesson_plan", () => {
    function validLessonPlan(overrides: Record<string, unknown> = {}) {
      return {
        ...
        stages: [
          { name: "Warm-up / Review", durationMinutes: 9, purpose: "Retrieval + prior-knowledge bridge", procedure: [{ kind: "teacher_intro", text: "Quick oral recall." }, { kind: "pupil_work", text: "Bridge to today's target.", durationMinutes: 4 }] },
          { name: "Input", durationMinutes: 10, purpose: "Dialog with passive-voice pattern", procedure: [{ kind: "teacher_intro", text: "Read the dialog aloud." }] },
          { name: "Guided Practice", durationMinutes: 20, purpose: "Gap fill, MCQ, matching", procedure: [{ kind: "pupil_work", text: "Gap fill.", durationMinutes: 6 }, { kind: "pupil_work", text: "MCQ.", durationMinutes: 6 }, { kind: "correction", text: "Matching." }] },
          { name: "Production", durationMinutes: 5, purpose: "Error correction", procedure: [{ kind: "pupil_work", text: "Find and fix the error.", durationMinutes: 5 }] },
          { name: "Wrap-up", durationMinutes: 1, purpose: "Exit ticket", procedure: [{ kind: "correction", text: "Thumbs up/down on I-can statements." }] },
        ],
